        ...
        <div className="containers">
            <div className="about-content">
                ...
                <div className="text-side">
                    ...
                    <p>
                        Hey, My name is Tahir, As a Beginner / Junior Front-End Developer, am also a Student at SMIT. I possess an impressive arsenal of skills in HTML, CSS, JavaScript, React, Material-UI and Tailwind.
                        <br /><br />
